...
from extract_chain import extract_and_cache_chain
...
# Both run whether or not a saved stage was opened: each checks for
# /World/lite6 itself and no-ops if it isn't present.
setup_ros2_control_graph()
extract_and_cache_chain()
